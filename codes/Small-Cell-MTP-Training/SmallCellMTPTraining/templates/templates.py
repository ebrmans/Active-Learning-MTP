...
{mass_block}
pair_style mlip      load_from={pot} extrapolation_control=true threshold_save=2.1 threshold_break=10  extrapolation_control:save_extrapolative_to={preselected_cfg}
pair_coeff * *
...
# YM note: lead is fcc structure 
mdInputTemplate_fcc = """units            metal
dimension        3
boundary         p p p
...
create_box       {num_elem}  whole
{mass_block}
pair_style mlip      load_from={pot} extrapolation_control=true threshold_save={threshold_save} threshold_break={threshold_break}  extrapolation_control:save_extrapolative_to=preselected.cfg
pair_coeff * *
